...
export const TourModal = forwardRef<TourModalHandle, Props>(function TourModal(
  {
  ...
  const animateMove = useCallback<TourModalHandle['animateMove']>(
    async (rect) => {
