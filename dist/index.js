...
__export(src_exports, {
  CoachMarkProvider: () => CoachMarkProvider,
...
// src/contexts/CoachMarkProvider.tsx
var import_mitt = __toESM(require("mitt"));
var import_react8 = __toESM(require("react"));
var import_react_native7 = require("react-native");

// src/components/CoachMarkModal.tsx
...
init_style();
var Tooltip = ({ labels }) => {
  const { goToNext, goToPrev, stop, currentStep, isFirstStep, isLastStep } = useCoachMark();
  const handleStop = () => {
    void stop();
  };
  const handleNext = () => {
...
var CoachMarkModal = (0, import_react5.forwardRef)(
  function CoachMarkModal2({
...
var CoachMarkContext = (0, import_react8.createContext)(void 0);
var CoachMarkProvider = (_a) => {
  var _b = _a, {
    verticalOffset = 0,
    children
  ...
  const coachMarkEvents = (0, import_react8.useRef)((0, import_mitt.default)()).current;
  ...
  return /* @__PURE__ */ import_react8.default.createElement(CoachMarkContext.Provider, { value }, /* @__PURE__ */ import_react8.default.createElement(import_react8.default.Fragment, null, /* @__PURE__ */ import_react8.default.createElement(
    CoachMarkModal,
    __spreadValues({
      ref: modal
    }, rest)
...
var useCoachMark = () => {
  const value = (0, import_react8.useContext)(CoachMarkContext);
  if (value == null) {
...
// src/components/CoachMarkStep.tsx
...
var CoachMarkStep = ({
  ...
  }, [name, order, registerStep, unregisterStep, active, verison]);
  (0, import_react11.useEffect)(() => {
    if (active) {
      return () => {
