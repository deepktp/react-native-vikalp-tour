...
var CoachMarkContext = createContext(void 0);
var CoachMarkProvider = (_a) => {
  ...
  const coachMarkEvents = useRef5(mitt()).current;
  ...
  return /* @__PURE__ */ React6.createElement(CoachMarkContext.Provider, { value }, /* @__PURE__ */ React6.createElement(React6.Fragment, null, /* @__PURE__ */ React6.createElement(
    CoachMarkModal,
    __spreadValues({
      ref: modal
    }, rest)
